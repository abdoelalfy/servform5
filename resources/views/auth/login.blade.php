...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="dark" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
  <div class="auth-main v1">
    ...
    <img style="width:30%;margin-left:200px;margin-top:-25px;
    background: white;
    border-radius: 34px;
    padding: 30px"  src="{{ asset('assets/images/صور-شعار-رؤية-المملكة-2030-شفاف-بدون-خلفية-.png') }}" >
    <div class="auth-wrapper">
      <form method="post" action="{{ route('login') }}" class="auth-form">
        @csrf
        <div class="card mb-5 mt-3">
          <div class="card-header bg-dark">
            <h4 class="text-center text-white f-w-500 mb-0">تسجيل الدخول  لهيئة الرقابة</h4>
          </div>
          <div class="card-body">
